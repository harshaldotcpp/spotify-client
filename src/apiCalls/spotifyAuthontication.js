 ...
 function fetchAccessToken(code){
  ...
  function handleAutorizationResponse(){
     if(this.status === 200){
      ...
      window.location = "https://accounts.spotify.com/authorize?client_id=a201e1c8ee7c4676886781255be2c68b&response_type=code&redirect_uri=http://localhost:8158/index.html&scope=user-read-recently-played%20user-read-currently-playing%20user-read-playback-position%20user-top-read";        
